...
//         <Row className="align-items-center mb-7 gx-0" style={{ minHeight: '400px' }}>
...
//                 alt="Values"
//                 fluid
//                 style={{ width: '100%', objectFit: 'cover', display: 'block', marginTop:'1.5cm' }}
//               />
//             )}
//           </Col>
//         </Row>
